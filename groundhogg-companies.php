...
define( 'GROUNDHOGG_COMPANIES_VERSION', '3.1.1' );
define( 'GROUNDHOGG_COMPANIES_PREVIOUS_STABLE_VERSION', '3.0.1' );
...
define( 'GROUNDHOGG_COMPANIES_REQUIRED_CORE_VERSION', '2.6' );
