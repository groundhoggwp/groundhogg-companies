...
foreach ( $companies as $company ) {
	...
	?>
	<div class="gh-panel company postbox outlined">
		...
		<div class="inside">
			<ul class="info-list">
				...
				<li class="<?php echo $company->get_address() ? '' : 'hidden'?>"><span class="dashicons dashicons-location"></span><?php echo html()->e( 'a', [
						'href'   => 'http://maps.google.com/?q=' . $company->get_searchable_address(),
						'target' => '_blank'
					], $company->get_address(), false ); ?></li>
				<li class="<?php echo $phone ? '' : 'hidden'?>"><span class="dashicons dashicons-phone"></span><?php echo $phone ? html()->e( 'a', [
					'href' => 'tel:' . $phone
					], $phone ) : '-'; ?></li>
			</ul>
		</div>
...
<script>
  (($) => {
    $('.gh-panel.company button.handlediv').on('click', (e) => {
